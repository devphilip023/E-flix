    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
          ...
          <div class="form-group">
            <label for="cat_slug" class="col-form-label">Category:</label>
            <input type="text" class="form-control" id="cat_slug" name="cat_slug" placeholder="Enter Category Here" required="">
          </div>
