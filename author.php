      ...
      <div class="col-md-8">
        ...
        if (isset($_GET['auth'])) 
        {
         ...
         <div class="card-footer text-muted">
            ...
            Videographer<a href="#">E-Flix</a><br>
            <a href=""> <i class="fas fa-envelope"></i></a>&nbsp;&nbsp;<a href=""><i class="fab fa-facebook"></i></a>
          </div> <div class="card-footer text-muted">I have written professionally about video production my entire adult professional life. I aim to figure out how complicated video production and explain it in a way anyone can understand.</div>
